...
set rc [catch {
  ...
  set_property webtalk.parent_dir D:/song/LAB/Vivado/lab_reg/lab_reg.cache/wt [current_project]
  set_property parent.project_path D:/song/LAB/Vivado/lab_reg/lab_reg.xpr [current_project]
  set_property ip_repo_paths d:/song/LAB/Vivado/lab_reg/lab_reg.cache/ip [current_project]
  set_property ip_output_repo d:/song/LAB/Vivado/lab_reg/lab_reg.cache/ip [current_project]
  add_files -quiet D:/song/LAB/Vivado/lab_reg/lab_reg.runs/synth_1/main.dcp
  read_xdc D:/song/LAB/Vivado/lab_reg/lab_reg.srcs/constrs_1/new/lab_reg.xdc
